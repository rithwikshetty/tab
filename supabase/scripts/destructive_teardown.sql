...
drop function if exists public.resolve_or_create_non_group_container(jsonb) cascade;
drop function if exists public.guard_trip_kind() cascade;
drop function if exists public.enforce_lww() cascade;
drop function if exists public.log_expense_activity() cascade;
drop function if exists public.log_membership_activity() cascade;
drop function if exists public.log_settlement_activity() cascade;
drop function if exists public.log_trip_activity() cascade;
drop function if exists public.mark_activity_seen() cascade;
drop function if exists public.notify_activity_push() cascade;
drop function if exists public.push_targets_for_activity(uuid) cascade;
drop function if exists public.unread_activity_count(uuid) cascade;
