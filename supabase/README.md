...
- Expense creation/editing: write the expense, payments, and splits in one transaction/RPC. The database enforces that active payment and split totals equal the expense amount.
