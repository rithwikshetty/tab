...
insert into _r select has_function('public', 'create_expense_with_payments_and_splits', array['jsonb', 'jsonb', 'jsonb'], 'public.create_expense_with_payments_and_splits(jsonb, jsonb, jsonb) exists');
...
insert into _r select col_is_pk('public', 'expense_payments', array['expense_id', 'user_id'],    'expense_payments composite PK');
...
insert into _r select col_is_fk('public', 'expense_payments', 'expense_id',  'expense_payments.expense_id is FK');
insert into _r select col_is_fk('public', 'expense_payments', 'user_id',     'expense_payments.user_id is FK');
insert into _r select col_is_fk('public', 'expense_splits',   'expense_id',  'expense_splits.expense_id is FK');
insert into _r select col_is_fk('public', 'expense_splits',   'user_id',     'expense_splits.user_id is FK');
...
insert into _r select col_type_is('public', 'expense_payments', 'amount_paid', 'numeric(14,2)', 'expense_payments.amount_paid is numeric(14,2)');
insert into _r select col_type_is('public', 'expense_splits',   'amount_owed', 'numeric(14,2)', 'expense_splits.amount_owed is numeric(14,2)');
