...
private let inviteLog = Logger(subsystem: "com.rithwikshetty.roam", category: "invite")
...
final class InviteService {
    ...
    /// Parses an incoming `roam://invite?...` URL and stashes it for the next signed-in render.
    @discardableResult
    ...
    static func parse(_ url: URL) -> ParsedInvite? {
        guard url.scheme?.lowercased() == "roam",
